...
stdbuf -oL python -u ./train.py $PWD"/train_config.json" -n 50 -m "cnn_seq2seq" --run_setting "cnn_seq2seq-lstm(128), full meta, crop 64, lstm(128), T0-30m T0-1h, T0-1h30m" --scratch_dir $SCRATCH --user_config user_config.json --save_best
