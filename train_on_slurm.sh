...
stdbuf -oL python -u ./train.py $PWD"/train_config.json" -n 50 -m "double_cnn_lstm" --run_setting "double cnn lstm, on 20%, lr=0.0001,full meta except day time, crop 64, t0-1, t0-3, t0-6" --scratch_dir $SCRATCH --use_cache --user_config user_config.json --save_best
#stdbuf -oL python -u ./test.py
