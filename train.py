...
from dataloader.dataset import SolarDataset
from utils import *
...
if __name__ == "__main__":
    ...
    dataset = SolarDataset(data_frame_path, stations, scratch_dir=args.scratch_dir, data_loader_options=args.user_config) \
        .prefetch(tf.data.experimental.AUTOTUNE) 
    
    train_loss_results = []
    train_accuracy_results = []
    is_training = args.training
    loss_object = tf.keras.losses.SparseCategoricalCrossentropy(from_logits=True) # TODO determine the true loss, this is not the good one
