...
parser.add_argument("--update_pkl", default=True, type=bool, help="Update the pkl file paths.")
parser.add_argument("--update_ssh", default=True, type=bool, help="Get files from remote and update them.")
